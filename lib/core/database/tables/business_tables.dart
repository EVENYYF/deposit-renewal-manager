...
class Deposits extends Table {
  ...
  TextColumn get calculatedExpiryDate => text().nullable()();
...
class Renewals extends Table {
  ...
  TextColumn get sourceDepositId => text().unique().references(Deposits, #id)();
  @ReferenceName('targetRenewal')
  TextColumn get targetDepositId => text().unique().references(Deposits, #id)();
  TextColumn get renewedAtUtc => text()();
  TextColumn get sourceDeviceId => text()();
